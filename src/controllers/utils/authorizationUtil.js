...
var AuthorizationUtil = /** @class */ (function () {
    function AuthorizationUtil() {
    }
    AuthorizationUtil.getJWTKey = function () {
     ...
     */
    AuthorizationUtil.createJWT = function (userId, email) {
     ...
     */
    AuthorizationUtil.extractJWTInformation = function (jwtToken) {
        try {
            var payload = jwt.verify(jwtToken, this.getJWTKey(), {
                algorithm: "HS256"
            });
            return {
                email: payload.email,
