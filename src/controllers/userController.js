...
var UserController = /** @class */ (function () {
     ...
     * @param next
     */
    UserController.getMe = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    return [2 /*return*/, apiResponses_1.ApiResponse.sendSuccessResponse(user, res)];
                }
                catch (ignored) {
     ...
     * @param next
     */
    UserController.saveAvatar = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, imageFile, fileExtension, avatarFileName, userFilter, updateStatement, ignored_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        ...
                        if (!imageFile)
                            return [2 /*return*/, apiResponses_1.ApiResponse.sendErrorResponse(404, 'Na avatar image uploaded', res)];
                        fileExtension = imageFile.name.split('.').pop();
                        avatarFileName = "./public/media/avatars/" + userId + "." + fileExtension;
                        // moves file and saves in directory
                        return [4 /*yield*/, imageFile.mv(avatarFileName)];
                    case 1:
                        // moves file and saves in directory
                        _a.sent();
                        userFilter = {
                        ...
                        return [4 /*yield*/, user_model_1.User.findOneAndUpdate(userFilter, updateStatement, {})];
                    case 2:
                        _a.sent();
