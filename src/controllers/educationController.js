...
var EducationController = /** @class */ (function () {
     ...
     * @param next
     */
    EducationController.getEducations = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var educations;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, education_model_1.Education.find({})];
                    case 1:
                        educations = _a.sent();
                        ...
                        return [2 /*return*/, apiResponses_1.ApiResponse.sendSuccessResponse(educations, res)];
                }
            });
        });
    };
